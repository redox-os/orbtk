...
#[test]
fn test_contains() {
    let rect = Bounds::new(5, 8, 100, 80);
    ...
    let neg_rect = Bounds::new(-5, -8, 100, 80);
...
fn test_contains_rect() {
    let rect = Bounds::new(5, 8, 100, 80);
    let inner_rect = Bounds::new(10, 12, 20, 20);
    let outer_rect_one = Bounds::new(0, 0, 2, 3);
    let outer_rect_two = Bounds::new(105, 89, 100, 50);
    ...
    let neg_rect = Bounds::new(-5, -8, 100, 80);
    let inner_neg_rect = Bounds::new(-2, -6, 20, 20);
    let outer_neg_rect_one = Bounds::new(-30, -20, 2, 3);
    let outer_neg_rect_two = Bounds::new(105, 89, 100, 50);
...
fn test_intersects() {
    let rect = Bounds::new(5, 8, 100, 80);
    let inner_rect = Bounds::new(2, 6, 100, 20);
    let outer_rect_one = Bounds::new(0, 0, 2, 3);
    let outer_rect_two = Bounds::new(105, 89, 100, 50);
    ...
    let neg_rect = Bounds::new(-5, -8, 100, 80);
    let inner_neg_rect = Bounds::new(-2, -6, 100, 120);
    let outer_neg_rect_one = Bounds::new(-30, -20, 2, 3);
    let outer_neg_rect_two = Bounds::new(105, 89, 100, 50);
