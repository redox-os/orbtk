        ...
        for instruction in instructions {
            match instruction {
                ...
                Instruction2D::ClearRect {
                    ...
                    width,
                    height,
                } => self.clear_rect(*x as f32, *y as f32, *width as f32, *height as f32),
                ...
                Instruction2D::FillRect {
                    ...
                    width,
                    height,
                } => self.fill_rect(*x as f32, *y as f32, *width as f32, *height as f32),
                ...
                Instruction2D::LineTo { x, y } => self.line_to(*x as f32, *y as f32),
                Instruction2D::MoveTo { x, y } => self.move_to(*x as f32, *y as f32),
                Instruction2D::Restore() => self.restore(),
                Instruction2D::Rotate { angle } => self.rotate(*angle as f32),
                ...
                Instruction2D::SetLineWidth { width } => self.set_line_width(*width as f32),
                ...
                Instruction2D::Scale { x, y } => self.scale(*x as f32, *y as f32),
                Instruction2D::Stroke() => self.stroke(),
                Instruction2D::Transform { a, b, c, d, e, f } => self.transform(
                    *a as f32, *b as f32, *c as f32, *d as f32, *e as f32, *f as f32,
                ),
                Instruction2D::Translate { x, y } => self.translate(*x as f32, *y as f32),
                _ => {}
            }
        }
    }
