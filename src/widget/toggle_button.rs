use crate::{
    properties::{
        Constraint, ConstraintBuilder, FontIcon, FontIconProperty, OrientationProperty, PaddingProperty,
        PressedProperty, Text, TextProperty, SelectedProperty
    },
    theme::Selector,
...
template!(
    ...
    [TextProperty, FontIconProperty, PressedProperty, SelectedProperty]
);
