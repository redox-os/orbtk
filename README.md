...
[![crates.io](https://img.shields.io/badge/crates.io-0.3.1alpha5-orange.svg)](https://crates.io/crates/orbtk/0.3.1-alpha5)
[![docs.rs](https://img.shields.io/badge/docs-0.3.1alpha5-blue.svg)](https://docs.rs/crate/orbtk/0.3.1-alpha5)
...
Each widget has to implement the [Template trait](https://github.com/redox-os/orbtk/blob/develop/orbtk_core/src/widget_base/template.rs). The template defines the default values of a widget's properties as well as its structure. A
...
The [Context parameter](https://github.com/redox-os/orbtk/blob/develop/orbtk_core/src/widget_base/context.rs) of the update method provides access to the state's widget (entity) and its properties (components). It also provides functions to access the children of the widget, and to manipulate the widget tree.
...
It is possible to register a localization service on an application. There is also a ready to use [RonLocalization](https://github.com/redox-os/orbtk/blob/develop/orbtk_core/src/localization/ron_localization/mod.rs) service, that can read localization dictionaries in the [RON](https://github.com/ron-rs/ron) format.
...
To switch the language on runtime the `set_language` method of the [Context](https://github.com/redox-os/orbtk/blob/develop/orbtk_core/src/widget_base/context.rs) struct can be used.
