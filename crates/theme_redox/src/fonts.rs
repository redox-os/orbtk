...
pub const MATERIAL_ICONS_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/MaterialIcons.ttf");
...
pub const MATERIAL_ICONS_BASELINE_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/MaterialIcons-Baseline.woff2");
...
pub const MATERIAL_ICONS_OUTLINED_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/MaterialIcons-Outlined.woff2");
...
pub const MATERIAL_ICONS_ROUND_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/MaterialIcons-Round.woff2");
...
pub const MATERIAL_ICONS_SHARP_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/MaterialIcons-Sharp.woff2");
...
pub const MATERIAL_ICONS_TWOTONE_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/MaterialIcons-TwoTone.woff2");

/// The `regular` variant of the `Roboto` font family.
pub const ROBOTO_REGULAR_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/Roboto-Regular.ttf");

/// The `medium` variant of the `Roboto` font family.
pub const ROBOTO_MEDIUM_FONT: &[u8] =
    include_bytes!("../../theme_default/assets/fonts/Roboto-Medium.ttf");
