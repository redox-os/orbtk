...
use orbtk_render::Image as ImageTrait;
use orbtk_utils::prelude::*;

use crate::{Font, Image};
...
impl RenderWorker {
    fn new(
        ...
        let render_thread = thread::spawn(move || {
            ...
            let mut render_context_2_d =
                crate::render_context_2d::RenderContext2D::new(width, height);
...
pub struct RenderContext2D {
    ...
    measure_context: crate::render_context_2d::RenderContext2D,
}
...
impl RenderContext2D {
    ...
    pub fn new(width: f64, height: f64) -> Self {
        ...
        RenderContext2D {
            ...
            finish_receiver,
            tasks: vec![],
            measure_context: crate::render_context_2d::RenderContext2D::new(width, height),
        }
    }
...
impl orbtk_render::RenderContext2D<Image> for RenderContext2D {
    ...
    /// Draws the image.
    fn draw_image(&mut self, image: &Image, x: f64, y: f64) {
        self.sender
    ...
    fn draw_image_with_clip(&mut self, image: &Image, clip: Rectangle, x: f64, y: f64) {
        self.sender
