...
=======
                                    .attach(Grid::column(0))
                                    .attach(Grid::row(1))
                                    //.icon(material_icons_font_ttf::CHECK_FONT_ICON)
...
<<<<<<< HEAD
                                    .margin((0., 8., 0., 0.))
=======
                                    .icon(material_icons_font_ttf::MD_ALARM_ADD)
                                    .margin((0., 8., 2., 0.))
>>>>>>> 9c81a1c... widgets.rs: updates
                                    .attach(Grid::column(0))
                                    .attach(Grid::row(3))
		...
		Grid::new()
			...
			Grid::new()
				...
				Button::new()
				    ...
				    .class("single_content")
				    .id("remove-item-button")
				    .icon(material_icons_font_ttf::MINUS_FONT_ICON)
				...
				Button::new()
				    ...
				    .class("single_content")
				    .id("add-item-button")
				    .icon(material_icons_font_ttf::ADD_FONT_ICON)
...
>>>>>>> dc49248... widgets: convert to use the renamed ttf font
=======
