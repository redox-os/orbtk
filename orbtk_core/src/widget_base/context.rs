...
/// The `Context` structure provides access to widget entities.
///
/// Entities and their associated components are handled via the
/// underlying Entity Component System ([DCES]). Functions are offered
/// to handle the position of an entity in the tree, its associated
